...
namespace IBS.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260901142337_ReplaceLeadPhasesAndAddressAndFloorPlans")]
    partial class ReplaceLeadPhasesAndAddressAndFloorPlans
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IBS.Modules.Sales.Domain.Entities.QuotationCatalogEntry", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("5b4200d0-9d18-0325-2ad1-5d5f8c9e6bd5"),
                            CategoryKey = "carpentry",
                            CategoryName = "Carpentry",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            IsActive = true,
                        ...
                        new
                        {
                            Id = new Guid("9c93d14d-c9c0-e19c-4c14-662c2df7c4d2"),
                            CategoryKey = "carpentry",
                            CategoryName = "Carpentry",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            IsActive = true,
                        ...
                        new
                        {
                            Id = new Guid("456f15b0-4b02-ce8f-976f-474901d990a4"),
                            CategoryKey = "others",
                            CategoryName = "Others",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            IsActive = true,
                        ...
                        new
                        {
                            Id = new Guid("e1d6dc1a-a338-9377-67dc-dc10d97c7047"),
                            CategoryKey = "others",
                            CategoryName = "Others",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            IsActive = true,
                        ...
                        new
                        {
                            Id = new Guid("229fff54-c9ae-26ec-43ca-d0aba7c8ba85"),
                            CategoryKey = "others",
                            CategoryName = "Others",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            IsActive = true,
                        ...
                        new
                        {
                            Id = new Guid("a645a351-e9ee-ea6d-654f-d1e4a873f076"),
                            CategoryKey = "others",
                            CategoryName = "Others",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            IsActive = true,
